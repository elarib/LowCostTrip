...
/**
 * Performance test for the HotelReservation entity.
 */
class HotelReservationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the HotelReservation entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all hotelReservations")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created hotelReservation")
                .get("${new_hotelReservation_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created hotelReservation")
            .delete("${new_hotelReservation_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
